...
export default function NewCourseDialogue({ showCourses, setShowCourses }) {
    ...
    const handleChange = (prop, event) => {
        setDetails((details) => {
            return { ...details, prop: event.target.value };
        });
        console.log(details);
        if (prop === "cost") {
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <Stack spacing={2}>
                        ...
                        <RadioGroup aria-labelledby="demo-radio-buttons-group-label" defaultValue="Online" name="radio-buttons-group">
            ...
            <Dialog open={open2} onClose={handleClose}>
                ...
                <DialogContent>
                    <Stack spacing={2}>
                        ...
                        <OutlinedInput id="outlined-adornment-amount" onChange={(e) => handleChange("cost", e)} startAdornment={<InputAdornment position="start">$</InputAdornment>} placeholder={"Course Price"} error={errorCoursePrice != null} helperText={errorCoursePrice} />
                    </Stack>
                </DialogContent>
                <DialogActions>
