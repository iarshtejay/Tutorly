            ...
            <Box sx={{ marginBottom: '70px' }}>
                <AppBar>
                    <Toolbar height='10vh' display='flex' justifyContent='space-between' padding='20px' backgroundColor='white'>
                        ...
                        >
                            {links.map((link) => (
                                <Link href={link.url} target="_blank" underline="none" key={link.id} display="flex" flexGrow="1.1">
                                    <Typography color="#fff" fontWeight="bold" >{link.route}</Typography>
                                </Link>
                            ))}
                        </Box>}
                ...
                <Grid container spacing={6} display='flex' alignItems='center' maxWidth='1300px' padding='50px'>
                    <Grid item xs={12} md={7}>
                        ...
                        <Typography variant="h6" opacity='0.4' paddingBottom='30px'>
                            Tutorly provides organisations, and schools with a fair and cost-effective online tutoring platform. Through rapid, on-demand,
                            drop-in access to qualified teachers at any time, anywhere, and all inside a safe and secure online learning environment,
            ...
            <Box flexGrow='1' padding='10px' maxWidth='700px' margin='30px auto' >
                ...
                >
                    <TextField
                        ...
                        style={{ padding: "6px", marginBottom: '20px !important' }}
                    />
